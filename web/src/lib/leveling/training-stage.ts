...
export const TRAINING_STAGES: TrainingStage[] = [
  {
    ...
    label: 'Just Starting',
    ordinal: 0,
    description: 'First steps. Building the habit. 2 sessions per week, linear progression.',
  ...
  },
  {
    ...
    label: 'Novice',
    ordinal: 1,
    description: 'Learning form, building base. 3 sessions per week, linear progression.',
  ...
  },
  {
    ...
    ordinal: 2,
    description: 'Consistent. Adding structure. 3-4 sessions, double progression.',
    defaultWeeklySessions: 3,
    defaultWeeklyTarget: 3,
  ...
  },
  {
    ...
    label: 'Intermediate',
    ordinal: 3,
    description: 'Solid foundation. 4 sessions per week, double progression.',
  ...
  },
  {
    ...
    ordinal: 4,
    description: 'Refined. Block-aware. 4-5 sessions, periodised progression.',
    defaultWeeklySessions: 4,
    defaultWeeklyTarget: 4,
  ...
  },
  {
    ...
    label: 'Advanced',
    ordinal: 5,
    description: 'High volume, structured. 5 sessions per week, periodised progression.',
  ...
  },
  {
    ...
    label: 'Elite',
    ordinal: 6,
    description: 'Peak performance. 5-6 sessions per week, periodised progression.',
    defaultWeeklySessions: 5,
    defaultWeeklyTarget: 5,
    progressionStyle: 'periodised',
    suggestable: true,

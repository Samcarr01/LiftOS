  ...
  return (
    <div className="page-shell">
      <div className="page-content py-4 md:py-6">
        <header className="sticky top-0 z-30 -mx-5 -mt-4 border-b border-white/[0.06] bg-[oklch(0.10_0.012_260/0.92)] px-5 pb-3 pt-[max(0.75rem,env(safe-area-inset-top))] md:-mt-6">

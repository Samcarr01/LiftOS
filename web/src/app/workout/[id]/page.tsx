  ...
  return (
    <div className="page-shell">
      <div className="page-content py-4 md:py-6">
        <header className="sticky top-0 z-30 -mx-5 -mt-4 border-b border-white/[0.06] bg-white/[0.10] px-5 pb-3 pt-[max(0.75rem,env(safe-area-inset-top))] backdrop-blur-2xl md:-mt-6">
          ...
          <div className="modal-surface w-full max-w-sm rounded-2xl p-5 space-y-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <button
                ...
                disabled={discarding}
                className="flex h-11 w-full items-center justify-center gap-2 rounded-xl bg-destructive text-sm font-semibold text-destructive-foreground transition-all duration-150 hover:bg-destructive/90 active:scale-[0.98] disabled:opacity-60 disabled:hover:bg-destructive"
              >

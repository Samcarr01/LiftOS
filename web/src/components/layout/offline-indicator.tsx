...
export function OfflineProvider() {
  ...
  return (
    <div
      role="status"
      aria-live="polite"
      className="fixed inset-x-0 top-0 z-[60] flex items-center justify-center gap-2 bg-yellow-600/95 px-4 pt-[max(0.5rem,env(safe-area-inset-top))] pb-2 text-sm font-medium text-white backdrop-blur-sm"
    >

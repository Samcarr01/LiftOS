...
export function PwaInstallBanner() {
  ...
  return (
    <div className="content-card chrome-surface fixed inset-x-0 bottom-24 z-50 mx-4 flex items-center gap-3 px-4 py-3 md:bottom-6 md:left-auto md:right-24 md:w-80">

...
export function PwaInstallBanner() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-24 z-50 mx-4 flex items-center gap-3 rounded-[24px] border border-white/10 bg-[rgba(12,20,38,0.88)] px-4 py-3 shadow-[0_22px_55px_-28px_rgba(2,10,28,0.95)] backdrop-blur-xl md:bottom-6 md:left-auto md:right-24 md:w-80">
      ...
      <button
        onClick={dismiss}
        className="shrink-0 flex h-8 w-8 items-center justify-center rounded-full hover:bg-white/8"
        aria-label="Dismiss"
      >

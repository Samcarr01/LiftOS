 ...
 *
 * Re-generate with: `supabase gen types typescript --project-id bourwlahxdqaotvwrvce`
 * ⚠️  Do not hand-edit jsonb columns — use the typed wrappers in app.ts instead.
 */
